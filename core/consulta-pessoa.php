<?php
	...
	try {
		...
		$objPHPExcel = $objReader->load('pessoas.csv'); //indica qual o arquivo CSV que será convertido
		$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
		$objWriter->save('pessoas.xls'); // Resultado da conversão; um arquivo do EXCEL   
